...
/**
 * Strings for component 'admin', language 'ru', version '4.0'.
 *
 * @package     admin
 * @category    string
...
$string['xmlrpcmnetauthenticationenabled'] = 'Обнаружено, что на вашем сайте включена аутентификация MNet. Эта функция зависит от расширения PHP XML-RPC, которое PHP больше не поддерживает.';
