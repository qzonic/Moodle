...
Открыть проект в интернете [тык](http://45.8.99.192/).
...
3. В контейнере postgres запущена база данных Postgres, дополнитеотьно создается волюм, в котором сохраняется база данных.
